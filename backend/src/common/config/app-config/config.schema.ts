...
export const configSchema = z
    .object({
        ...
        // PostgreSQL whitelist routing (all optional — feature disabled if any is missing)
        PG_HOST: z.optional(z.string()),
        PG_PORT: z.optional(z.string()),
        PG_DATABASE: z.optional(z.string()),
        PG_USER: z.optional(z.string()),
        PG_PASSWORD: z.optional(z.string()),
    })
